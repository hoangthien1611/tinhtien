  ...
  render(): React.ReactNode {
    return (
      <ModalOverlay>
        <ActionContentbox
          headingElements={
            <ContentBoxElements.Title text="Add a new expense" />
          }
    ...
    return (
      <ContentBoxElements.Footer style={{ marginTop: "20px", float: "right" }}>
        <Button
          ...
          disabled={
            this.validateAmountResult !== ValidateResult.Ok ||
            this.validateDescriptionResult !== ValidateResult.Ok
          }
        >
          Ok
        </Button>
      ...
      <>
        ...
        <TextLineStateless
          ...
          errorMessage={
            this.validateDescriptionResult === ValidateResult.Ok
              ? undefined
              : this.validateDescriptionResult
          }
        />
        <TextLineStateless
          className="padding-bot-10"
